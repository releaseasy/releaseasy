...
import { D as getThemeVariables3, H as setAccDescription, U as setAccTitle, a as clear, b as getConfig, c as configureSvgSize, f as defaultConfig_default, q as setDiagramTitle, v as getAccDescription, w as getDiagramTitle, y as getAccTitle, z as sanitizeText } from "./chunk-O7XYJQB3-mKDgYvQm.js";
import { t as linear } from "./linear-UaR2UT4Q.js";
import { t as ordinal } from "./ordinal-4XND2UYT.js";
import { t as initRange } from "./init-D1VpViHI.js";
import { i as cleanAndMerge } from "./chunk-ZIGJFQKS-CX9G_8OE.js";
...
import { t as computeDimensionOfText } from "./chunk-MBY4JIJT-DQOOXU90.js";
...
//#endregion
//#region node_modules/.pnpm/mermaid@12.0.0/node_modules/mermaid/dist/chunks/mermaid.core/xychartDiagram-PMCCYNJV.mjs
var parser = (function() {
...
var LEGEND_MARKER_TO_FONT_RATIO = .75;
var LEGEND_ITEM_SPACING_TO_FONT_RATIO = .5;
var LEGEND_MARKER_SPACING_TO_FONT_RATIO = .35;
...
var ChartLegend = class {
	...
	calculateSpace(availableSpace) {
		...
		const { fontSize, markerSize, markerSpacing, itemSpacing } = getLegendLayout(this.chartConfig.legendFontSize);
		const textDimension = this.textDimensionCalculator.getMaxDimension(this.visiblePlots.map((plot) => plot.title), fontSize);
	...
	getDrawableElements() {
		...
		const barMarkers = [];
		const lineMarkers = [];
		for (const [index, plot] of this.visiblePlots.entries()) if (isBarPlot(plot)) barMarkers.push({
			x: startX,
...
function getChartLegendComponent(chartConfig, chartData, chartThemeConfig, tmpSVGGroup2) {
	return new ChartLegend(new TextDimensionCalculatorWithFont(tmpSVGGroup2), chartConfig, chartData, chartThemeConfig);
}
