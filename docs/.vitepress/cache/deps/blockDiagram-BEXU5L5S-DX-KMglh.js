...
import { a as clear, at as rgba, b as getConfig, c as configureSvgSize, s as common_default, x as getConfig2 } from "./chunk-O7XYJQB3-mKDgYvQm.js";
import { t as channel } from "./channel-DXKY7-XB.js";
import { A as float64ArrayTag, B as symbolTag, C as argumentsTag, D as dataViewTag, E as booleanTag, F as numberTag, G as getTag, H as uint32ArrayTag, I as objectTag, L as regexpTag, M as int32ArrayTag, N as int8ArrayTag, O as dateTag, P as mapTag, R as setTag, T as arrayTag, U as uint8ArrayTag, V as uint16ArrayTag, W as uint8ClampedArrayTag, b as isPrimitive, j as int16ArrayTag, k as float32ArrayTag, l as getStylesFromArray, v as isTypedArray, w as arrayBufferTag, z as stringTag } from "./chunk-ZIGJFQKS-CX9G_8OE.js";
...
import { i as isColorTheme, n as colorSlotCount, o as safeLook, r as hasPalette, s as stampColorSlot } from "./chunk-J5ZVWO5B-DBdtyzdO.js";
import "./chunk-7INBJB4K-Cqr6ftBk.js";
import { i as positionNode, r as insertNode } from "./chunk-5DYCD2WN-CR4S9APN.js";
...
import { t as Graph } from "./graphlib-CW_JDuzg.js";
...
//#endregion
//#region node_modules/.pnpm/mermaid@12.0.0/node_modules/mermaid/dist/chunks/mermaid.core/blockDiagram-BEXU5L5S.mjs
var parser = (function() {
	...
	for (const block of blockList) {
		...
		if (block.type === "column-setting") parent.columns = block.columns ?? -1;
			...
			if (existingBlock === void 0) {
				if (block.type === "composite") block.colorIndex = nextColorIndex++;
...
function getNodeFromBlock(block, db2, positioned = false) {
	...
	const cssCompiledStyles = (vertex?.classes ?? []).flatMap((className) => db2.getClasses().get(className)?.styles ?? []);
	let radius = 0;
	let shape = "rect";
	let padding;
	switch (vertex.type) {
...
async function insertBlockPositioned(elem, block, db2) {
	...
	if (db2.getBlock(node.id).type !== "space") {
		...
		if (node.colorIndex !== void 0) stampColorSlot(el, node.colorIndex, config.theme, config.themeVariables?.borderColorArray);
...
async function insertEdges(elem, edges, blocks2, db2, id) {
	...
	for (const edge of edges) if (edge.start && edge.end) {
		...
		if (startBlock?.size && endBlock?.size) {
			...
			}, {}, "block", g.node(edge.start), g.node(edge.end), id);
			if (edge.label) {
