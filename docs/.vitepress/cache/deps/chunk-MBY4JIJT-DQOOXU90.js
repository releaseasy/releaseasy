...
import { A as hasKatex, F as renderKatexSanitized, b as getConfig, s as common_default, z as sanitizeText } from "./chunk-O7XYJQB3-mKDgYvQm.js";
import { a as decodeEntities } from "./chunk-ZIGJFQKS-CX9G_8OE.js";
...
//#endregion
//#region node_modules/.pnpm/mermaid@12.0.0/node_modules/mermaid/dist/chunks/mermaid.core/chunk-MBY4JIJT.mjs
	...
	*/
	...
	stop() {
		...
		if (root) {
			...
			if (this.autoPrint) this.printSummary(root, label);
		}
	...
	begin(name) {
		...
		else this.roots.push(span);
		this.stack.push(span);
		if (hasPerformance && typeof performance.mark === "function") try {
	...
	/** Close the most recently opened span. No-op unless enabled. */
		...
		if (hasPerformance && typeof performance.measure === "function") try {
	...
	*/
	...
	printSummary(root = this.report(), label) {
		...
		if (bucketNames.length > 0) {
			...
			for (const name of bucketNames) lines.push(`${this.buckets[name].toFixed(1).padStart(8)}       ${name}`);
		}
...
var fastdom_default = (function(win) {
	...
	__name(mixin, "mixin");
	return win.fastdom = win.fastdom || new FastDom();
...
var fastdom_default2 = fastdom_default.extend({ 
/**
...
var createText = /* @__PURE__ */ __name(async (el, text = "", { style = "", isTitle = false, classes = "", useHtmlLabels = true, markdown = true, isNode = true, width = 200, minWidth = 0, addSvgBackground = false } = {}, config) => {
	...
	if (useHtmlLabels) {
		...
		}, width, classes, addSvgBackground, config, minWidth);
	} else {
...
//#endregion
export { dedent as a, markdownToLines as i, createText as n, fastdom_default2 as r, computeDimensionOfText as t };
