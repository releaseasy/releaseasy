...
import { H as setAccDescription, U as setAccTitle, a as clear, et as purify, q as setDiagramTitle, s as common_default, v as getAccDescription, w as getDiagramTitle, x as getConfig2, y as getAccTitle } from "./chunk-O7XYJQB3-mKDgYvQm.js";
import { g as utils_default, s as generateId } from "./chunk-ZIGJFQKS-CX9G_8OE.js";
...
//#region node_modules/.pnpm/mermaid@12.0.0/node_modules/mermaid/dist/chunks/mermaid.core/stateDiagram-v2-GCMORJYK.mjs
var parser = (function() {
...
var containerColorIndex = /* @__PURE__ */ new Map();
var colorSlotFor = /* @__PURE__ */ __name((shape, itemId, parent, userStyled) => {
	if (shape === SHAPE_DIVIDER && parent?.id !== void 0 && containerColorIndex.has(parent.id)) {
		const inherited = containerColorIndex.get(parent.id);
		containerColorIndex.set(itemId, inherited);
		return inherited;
	}
	const slot = nextColorIndex++;
	const effective = userStyled ? void 0 : slot;
	...
	*/
	...
	getData() {
		...
		for (const node of this.nodes) {
			...
			if (!node.isGroup) node.minWidth ??= config.state?.minNodeWidth;
		}
		return {
			nodes: this.nodes,
			edges: this.edges,
			other: {},
			config,
			direction: getDir2(this.getRootDocV2())
		};
	}
	getConfig() {
