import { n as __name, t as __export } from "./chunk-Y2CYZVJY-BeyD3uSL.js";
import { B as setLogLevel, z as log } from "./src-nnofB4Gp.js";
...
//#endregion
//#region node_modules/.pnpm/mermaid@12.0.0/node_modules/mermaid/dist/chunks/mermaid.core/chunk-O7XYJQB3.mjs
var frontMatterRegex = /^([^\S\n\r]*)-{3}\s*[\n\r](.*?)[\n\r]\1-{3}\s*[\n\r]+/s;
var directiveRegex = /%{2}{\s*(?:(\w+)\s*:|(\w+))\s*(?:(\w+)|((?:(?!}%{2}).|\r?\n)*))?\s*(?:}%{2})?/gi;
var whitespace = /\s/;
var stripAnyComments = /* @__PURE__ */ __name((text) => {
	let out = "";
	let consumed = 0;
	let searchFrom = 0;
	while (searchFrom < text.length) {
		...
		if (lineEnd === -1) break;
		let start = marker;
		while (start > consumed && whitespace.test(text[start - 1])) start--;
	...
	if (src !== void 0 && src !== null && typeof dst === "object" && typeof src === "object") {
		...
		Object.entries(src).forEach(([key, srcValue]) => {
			if (typeof srcValue === "object") {
				...
				if (Object.hasOwn(dst, key)) dstWithKeys[key] = srcValue;
...
var Theme = class {
	...
	calculate(overrides) {
		...
		if (Object.hasOwn(overrides, "nodeBorder") && !Object.hasOwn(overrides, "useGradient")) this.useGradient = false;
	}
};
...
var Theme6 = class {
	...
	updateColors() {
		...
		this.activationBkgColor = this.activationBkgColor || this.secondaryColor;
		this.sequenceNumberColor = this.sequenceNumberColor || invert(this.lineColor);
		this.rectBkgColor = this.rectBkgColor || (isDark(this.background) ? lighten(this.background, 4) : darken(this.background, 4));
...
var Theme10 = class {
	...
	updateColors() {
		...
		this.classText = this.classText || this.textColor;
		for (let i = 0; i < 8; i++) this["fillType" + i] = this["fillType" + i] || this.bkgColorArray[i];
		for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) this["pie" + (i + 1)] = this["pie" + (i + 1)] || this["cScale" + i];
		this.pieTitleTextSize = this.pieTitleTextSize || "25px";
		this.pieTitleTextColor = this.pieTitleTextColor || this.taskTextDarkColor;
		this.pieSectionTextSize = this.pieSectionTextSize || "17px";
		this.pieSectionTextColor = this.pieSectionTextColor || this.textColor;
		...
		this.pieOuterStrokeColor = this.pieOuterStrokeColor || "black";
		this.pieOpacity = this.pieOpacity || "0.7";
		for (let i = 0; i < 8; i++) this["venn" + (i + 1)] = this["venn" + (i + 1)] ?? this.borderColorArray[i % this.borderColorArray.length];
		this.vennTitleTextColor = this.vennTitleTextColor ?? this.titleColor;
		this.vennSetTextColor = this.vennSetTextColor ?? this.textColor;
		this.quadrant1Fill = this.quadrant1Fill || primaryColor;
		this.quadrant2Fill = this.quadrant2Fill || adjust(primaryColor, {
...
var config = {
	...
	class: {
		theme: config_schema_default.class?.theme,
		look: config_schema_default.class?.look,
		layout: config_schema_default.class?.layout,
		hideEmptyMembersBox: false,
		hierarchicalNamespaces: true
	},
	gantt: {
	...
	usecase: { ...config_schema_default.usecase },
	railroad: {
...
var getDiagramConfigKey = /* @__PURE__ */ __name((diagramType) => DIAGRAM_CONFIG_KEY_ALIASES[diagramType] ?? diagramType, "getDiagramConfigKey");
...
var LOOKS = /* @__PURE__ */ new Set([
	"classic",
	"handDrawn",
	"neo"
]);
var isUsableAppearance = /* @__PURE__ */ __name((key, value) => {
	if (key === "theme") return value === "null" || Object.hasOwn(themes_default, value);
	return key !== "look" || LOOKS.has(value);
}, "isUsableAppearance");
var readAppearance = /* @__PURE__ */ __name((layer, diagramConfigKey2, key) => {
	if (!layer) return;
	return [layer[diagramConfigKey2]?.[key], layer[key]].find((value) => value !== void 0 && isUsableAppearance(key, value));
}, "readAppearance");
...
var resolveAppearance = /* @__PURE__ */ __name((cfg, sumOfDirectives) => {
	if (!diagramConfigKey) return;
	const layers = [
		sumOfDirectives,
		...[...directives].reverse(),
		siteConfigDelta,
	...
	for (const key of APPEARANCE_KEYS) for (const layer of layers) {
		const value = readAppearance(layer, diagramConfigKey, key);
		if (value === void 0) continue;
		cfg[key] = value;
		if (section?.[key] !== void 0) section[key] = value;
		break;
	}
}, "resolveAppearance");
var updateCurrentConfig = /* @__PURE__ */ __name((siteCfg, _directives) => {
	...
	if ((Boolean(sumOfDirectives.theme) || cfg.theme !== siteCfg.theme) && cfg.theme && Object.hasOwn(themes_default, cfg.theme)) {
...
var setDiagramConfigScope = /* @__PURE__ */ __name((diagramType) => {
...
var setSiteConfig = /* @__PURE__ */ __name((conf) => {
	...
	if (conf.theme && Object.hasOwn(themes_default, conf.theme)) siteConfig.themeVariables = themes_default[conf.theme].getThemeVariables(conf.themeVariables);
	updateCurrentConfig(siteConfig, directives);
	return siteConfig;
}, "setSiteConfig");
...
var renderKatexUnsanitized = /* @__PURE__ */ __name(async (text, config2) => {
	...
	{
		const { default: katex } = await import("./katex-DhTJdtYJ.js");
...
//#endregion
export { updateSiteConfig as $, hasKatex as A, sanitizeText3 as B, getDiagramLoader as C, getThemeVariables3 as D, getSiteConfig as E, renderKatexSanitized as F, setConfig2 as G, setAccDescription as H, reset as I, setSiteConfig as J, setDiagramConfigScope as K, sanitizeCss as L, parseGenericTypes as M, registerDiagram as N, getUrl as O, registerLazyLoadedDiagrams as P, themes_default as Q, sanitizeDirective as R, getDiagram as S, getEffectiveHtmlLabels as T, setAccTitle as U, saveConfigFromInitialize as V, setConfig as W, setupGraphViewbox2 as X, setupGraphViewbox as Y, styles_default as Z, frontMatterRegex as _, clear as a, rgba as at, getConfig as b, configureSvgSize as c, defaultConfig2 as d, purify as et, defaultConfig_default as f, evaluate as g, directiveRegex as h, calculateMathMLDimensions as i, isDark as it, lineBreakRegex as j, getUserDefinedConfig as k, cssStyleSheetToString as l, detectors as m, addDirective as n, lighten as nt, commonDb_exports as o, Color as ot, detectType as p, setDiagramTitle as q, assignWithDepth_default as r, adjustChannel as rt, common_default as s, Utils as st, UnknownDiagramError as t, darken as tt, defaultConfig as u, getAccDescription as v, getDiagramTitle as w, getConfig2 as x, getAccTitle as y, sanitizeText as z };
