...
import { c as updateNodeBounds } from "./chunk-7INBJB4K-Cqr6ftBk.js";
import { a as setNodeElem, i as positionNode, n as getSubGraphTitleMargins } from "./chunk-5DYCD2WN-CR4S9APN.js";
import { r as insertCluster } from "./chunk-UA2S7LBM-qM4-1ylw.js";
import { a as insertEdgeLabel, i as insertEdge, l as positionEdgeLabel } from "./chunk-Z7XXMR3K-Dp6XDiuE.js";
import { $ as arrayMap, A as baseKeys, B as baseRest, C as baseFlatten, D as castPath, E as toKey, F as baseUnary, G as arrayEach, H as eq, I as isBuffer, J as constant, K as setToString, L as isArguments, M as arrayLikeKeys, N as isTypedArray, O as toString, P as nodeUtil, Q as isArray, R as isPrototype, S as Stack, T as baseGet, U as isIndex, V as overRest, W as baseFindIndex, X as identity, Y as isFunction, Z as isObject, _ as _getTag_default, a as filter, b as getSymbols, c as isArrayLikeObject, d as baseFor, et as isSymbol, f as baseIteratee, g as Uint8Array, h as hasPath, i as values, it as root, j as overArg, k as keys, l as baseEach, m as hasIn, n as reduce, nt as baseGetTag, o as forEach, p as baseProperty, q as defineProperty, r as isUndefined, rt as Symbol, s as castFunction, t as Graph, tt as isObjectLike, u as baseForOwn, v as getAllKeys, w as arrayPush, x as stubArray, y as baseGetAllKeys, z as isArrayLike } from "./graphlib-CW_JDuzg.js";
import { c as sortNodesByHierarchy, i as createLayoutElementGroups, n as clusterDb, o as findNonClusterChild, r as createCommonLayoutRenderer, s as insertMeasuredNode, t as adjustClustersAndEdges } from "./chunk-3FUC2YCW-s_D-ng71.js";
...
//#endregion
//#region node_modules/.pnpm/mermaid@12.0.0/node_modules/mermaid/dist/chunks/mermaid.core/dagre-6A5THRUB.mjs
...
var measureDagreGraph = /* @__PURE__ */ __name(async ({ element: _elem, graph, diagramType, id, parentCluster, siteConfig }) => {
	const dir = graph.graph().rankdir;
	log.trace("Dir in recursive render - dir:", dir);
	const { clusters, edgePaths, edgeLabels, nodes, rootGroups: elem } = createLayoutElementGroups(_elem, { edgePathsClass: "edgePaths" });
	...
	await Promise.all(graph.nodes().map(async function(v) {
		...
		if (node?.clusterNode) {
			...
			await insertMeasuredNode(nodes, graph.node(v), {
				config: siteConfig,
				dir
			});
		}
...
var normalizeDagreNode = /* @__PURE__ */ __name((graph, nodeId, subGraphTitleTotalMargin) => {
	...
	if (node?.clusterNode) normalizedNode.y = (node.y ?? 0) + subGraphTitleTotalMargin;
	else if (graph.children(nodeId).length > 0) normalizedNode.height = (node.height ?? 0) + subGraphTitleTotalMargin;
	else normalizedNode.y = (node.y ?? 0) + subGraphTitleTotalMargin / 2;
	return normalizedNode;
}, "normalizeDagreNode");
var applyDagreNodeLayout = /* @__PURE__ */ __name((targetNode, dagreNode) => {
	DAGRE_NODE_LAYOUT_PROPERTIES.forEach((property) => {
		if (dagreNode[property] !== void 0) targetNode[property] = dagreNode[property];
	});
...
var applyDagreLayoutResult = /* @__PURE__ */ __name((data4Layout, measuredLayout) => {
	...
	sortNodesByHierarchy(graph).forEach((nodeId) => {
		...
		if (targetNode) applyDagreNodeLayout(targetNode, dagreNode);
	});
	const edgeOffsetY = subGraphTitleTotalMargin / 2;
	data4Layout.edges = getEdgesToRender(graph, edgeOffsetY, { mergeSelfLoops }).map(({ edge, start, end }) => normalizeDagreEdge(edge, start, end, edgeOffsetY));
	return data4Layout;
}, "applyDagreLayoutResult");
var paintDagreLayoutCore = /* @__PURE__ */ __name(async ({ elem, graph, groups: { clusters, edgePaths }, diagramType, id, mergeSelfLoops, subGraphTitleTotalMargin }) => {
	let diff = 0;
...
var runDagreLayoutCore = /* @__PURE__ */ __name((data4Layout, context) => {
	...
	if (!measuredLayout) throw new Error("runDagreLayoutCore requires measureDagreLayout to run first");
	runDagreGraphLayout(measuredLayout.graph);
...
var render = createCommonLayoutRenderer({
	...
	paintOptions: {
		clusterDb,
		getNodes: /* @__PURE__ */ __name((_data4Layout, { measure }) => sortNodesByHierarchy(measure.graph).map((nodeId) => measure.graph.node(nodeId)).filter(Boolean), "getDagrePaintNodes"),
		getEdgeNode: /* @__PURE__ */ __name((nodeId, _edge, { measure }) => nodeId ? measure.graph.node(nodeId) : void 0, "getDagreEdgeNode"),
