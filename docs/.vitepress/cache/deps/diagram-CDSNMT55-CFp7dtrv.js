...
import { H as setAccDescription, U as setAccTitle, a as clear, b as getConfig, c as configureSvgSize, f as defaultConfig_default, q as setDiagramTitle, v as getAccDescription, w as getDiagramTitle, y as getAccTitle, z as sanitizeText } from "./chunk-O7XYJQB3-mKDgYvQm.js";
import { i as cleanAndMerge } from "./chunk-ZIGJFQKS-CX9G_8OE.js";
import { t as selectSvgElement } from "./chunk-6AEJRKK7-CeavfKAn.js";
import { r as registerIconPacks, t as getIconSVG } from "./chunk-742MDFTN-DsvLQSVM.js";
import { n as parse } from "./mermaid-parser.core-B2mFUoPc.js";
import { t as populateCommonDb } from "./chunk-JWPE2WC7-Df5dtAGN.js";
import { t as ImperativeState } from "./chunk-2Q5K7J3B-UBd40NHA.js";
//#region node_modules/.pnpm/mermaid@12.0.0/node_modules/mermaid/dist/chunks/mermaid.core/diagram-CDSNMT55.mjs
var ALL_BOX_CHARS = /[─━│┃└┗├┣]/;
var BRANCH_CHAR = /[└┗├┣]/;
var DASH_CHAR = /[─━]/;
...
var ICON_GAP = 4;
var DESC_GAP = 16;
var resolveNodeIcons = /* @__PURE__ */ __name(async (root, config) => {
	const nodeIcons = [];
	const collect = /* @__PURE__ */ __name((node) => {
		const icon = getNodeIcon(node, config);
		if (icon) nodeIcons.push({
			icon,
			node
		});
	...
	collect(root);
	const resolvedIcons = await Promise.all(nodeIcons.map(async ({ icon, node }) => ({
		id: node.id,
...
var positionLabel = /* @__PURE__ */ __name((x, y, node, domElem, config, iconSVGs) => {
	...
	if (icon) nodeGroup.append("g").attr("class", "treeView-node-icon").attr("transform", `translate(${x + config.paddingX}, ${y + config.paddingY})`).html(iconSVGs.get(node.id) ?? "");
...
var drawTree = /* @__PURE__ */ __name((elem, root, config, iconSVGs) => {
	let totalHeight = 0;
	let totalWidth = 0;
	const renderInfos = [];
...
var renderer_default = { draw: /* @__PURE__ */ __name(async (text, id, _ver, diagObj) => {
	...
	const { totalHeight, totalWidth } = drawTree(treeElem, root, config, await resolveNodeIcons(root, config));
