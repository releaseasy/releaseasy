...
import { T as getEffectiveHtmlLabels, b as getConfig, x as getConfig2 } from "./chunk-O7XYJQB3-mKDgYvQm.js";
import { $ as cardinal_default, J as step_default, K as stepAfter, Q as catmullRom_default, X as monotoneX, Y as natural_default, Z as monotoneY, et as basis_default, g as utils_default, nt as bumpY, q as stepBefore, rt as linear_default, tt as bumpX, u as handleUndefinedAttr } from "./chunk-ZIGJFQKS-CX9G_8OE.js";
import { t as line_default } from "./line-BrhMZ-iB.js";
import { i as styles2String, n as isLabelStyle } from "./chunk-7PRAP22T-BsZhkbcM.js";
import { n as createText, r as fastdom_default2 } from "./chunk-MBY4JIJT-DQOOXU90.js";
import { t as at } from "./rough.esm-CukKpxpo.js";
import { t as createLabel_default } from "./chunk-7INBJB4K-Cqr6ftBk.js";
import { n as getSubGraphTitleMargins } from "./chunk-5DYCD2WN-CR4S9APN.js";
//#region node_modules/.pnpm/mermaid@12.0.0/node_modules/mermaid/dist/chunks/mermaid.core/chunk-Z7XXMR3K.mjs
...
var hasEdgeLabel = /* @__PURE__ */ __name((edge) => Boolean(edge.label || edge.startLabelLeft || edge.startLabelRight || edge.endLabelLeft || edge.endLabelRight), "hasEdgeLabel");
...
var generateDashArray = /* @__PURE__ */ __name((len, oValueS, oValueE) => {
	...
	const dashLength = 2;
	const gapLength = 2;
	const rawPairs = Math.floor(middleLength / 4);
	return `0 ${oValueS} ${Array(Number.isFinite(rawPairs) ? Math.max(0, rawPairs) : 0).fill(`${dashLength} ${gapLength}`).join(" ")} ${oValueE}`;
}, "generateDashArray");
...
var markers = {
	...
	hierarchy: /* @__PURE__ */ __name((elem, type, id) => {
...
//#endregion
export { insertEdgeLabel as a, markers_default as c, insertEdge as i, positionEdgeLabel as l, edgeLabels as n, markerOffsets as o, hasEdgeLabel as r, markerOffsets2 as s, clear as t, terminalLabels as u };
