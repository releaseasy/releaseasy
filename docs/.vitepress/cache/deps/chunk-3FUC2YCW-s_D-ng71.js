...
import { b as getConfig, x as getConfig2 } from "./chunk-O7XYJQB3-mKDgYvQm.js";
import { g as utils_default } from "./chunk-ZIGJFQKS-CX9G_8OE.js";
import { o as labelHelper } from "./chunk-7INBJB4K-Cqr6ftBk.js";
import { i as positionNode, n as getSubGraphTitleMargins, r as insertNode, t as clear } from "./chunk-5DYCD2WN-CR4S9APN.js";
import { r as insertCluster, t as clear$1 } from "./chunk-UA2S7LBM-qM4-1ylw.js";
import { a as insertEdgeLabel, c as markers_default, i as insertEdge, n as edgeLabels, r as hasEdgeLabel, t as clear$2, u as terminalLabels } from "./chunk-Z7XXMR3K-Dp6XDiuE.js";
import { t as Graph } from "./graphlib-CW_JDuzg.js";
//#region node_modules/.pnpm/mermaid@12.0.0/node_modules/mermaid/dist/chunks/mermaid.core/chunk-3FUC2YCW.mjs
...
async function measureGroupLabel(nodesGroup, node, measureWidth) {
	if (node.label) {
		const { shapeSvg, bbox } = await labelHelper(nodesGroup, measureWidth === void 0 ? node : {
			...node,
			width: measureWidth
		});
		node.labelBBox = {
...
async function createGraphWithElements(element, data4Layout, options = {}) {
	...
	if (globalThis.mermaidCaptureSizes) {
		const { captureNodeSizes } = await import("./sizeCapture-INFHLROL-m26XFsuT.js");
...
function createCommonLayoutRenderer({ prepareLayout, measureLayout, runLayoutCore, paintLayout, afterPaint, paintOptions }) {
	...
	return /* @__PURE__ */ __name(async function render(data4Layout, svg, helpers, options) {
		...
		(helpers?.insertMarkers ?? markers_default)(element, data4Layout.markers, data4Layout.type, data4Layout.diagramId);
...
//#endregion
export { defaultMeasureLayout as a, sortNodesByHierarchy as c, createLayoutElementGroups as i, clusterDb as n, findNonClusterChild as o, createCommonLayoutRenderer as r, insertMeasuredNode as s, adjustClustersAndEdges as t };
